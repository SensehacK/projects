...
$MyHostname = "sql110.byethost15.com";
$mysqli = new mysqli($MyHostname , $MyUsername, $MyPassword);



    // Retrieve all records and display them
    $result = mysql_query("SELECT * FROM b15_17774708_test.iot ORDER BY id DESC");


$profile_name = array_values(mysqli_fetch_array($mysqli->query("SELECT username from b15_17774708_test.profile WHERE id = 2 ")))[0]; //retrieving name 
...
$profile_age = array_values(mysqli_fetch_array($mysqli->query("SELECT age from b15_17774708_test.profile WHERE id = $profile_id")))[0];


$profile_name = array_values(mysqli_fetch_array($mysqli->query("SELECT username from b15_17774708_test.profile WHERE id = $profile_id")))[0]; //retrieving name 
...
$profile_email = array_values(mysqli_fetch_array($mysqli->query("SELECT nurse from b15_17774708_test.profile WHERE id = $profile_id")))[0]; // retrieving email address 
...
$latest_pulse = array_values(mysqli_fetch_array($mysqli->query("SELECT pulse FROM b15_17774708_test.iot ORDER BY id DESC LIMIT 1")))[0]; 
...
$profile_agegroup = array_values(mysqli_fetch_array($mysqli->query("SELECT age_group from b15_17774708_test.profile WHERE id = $profile_id")))[0];
...
$average_pulse = array_values(mysqli_fetch_array($mysqli->query("SELECT averagep FROM b15_17774708_test.referencedata where id= $profile_agegroup")))[0]; 
...
$min_pulse = array_values(mysqli_fetch_array($mysqli->query("SELECT pulse_min FROM b15_17774708_test.referencedata where id= $profile_agegroup")))[0]; 
...
$max_pulse = array_values(mysqli_fetch_array($mysqli->query("SELECT pulse_max FROM b15_17774708_test.referencedata where id= $profile_agegroup")))[0]; 
...
$profile_nurse = array_values(mysqli_fetch_array($mysqli->query("SELECT nurse from b15_17774708_test.profile WHERE id = $profile_id")))[0];
